...
/* =========================================================================
   PERSISTENCE — localStorage (per-browser, local)
   ========================================================================= */
...
function ExerciseRow({ we, exercise, index, onUpdate, onRemove, onDragStart, onDragOver, onDrop, dragging }) {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-wrap items-center gap-2 sm:justify-end">
        ...
        <button onClick={onRemove} className="rounded-md p-1.5 text-[#6C7178] hover:bg-[#3A1E1E] hover:text-[#E4572E]">
          <Trash2 size={15} />
        </button>
      </div>
    </div>
...
function DayCard({ day, exercises, onRename, onDuplicate, onDelete, onAddExercise, onRemoveExercise, onUpdateExercise, onReorder, expanded, onToggle }) {
...
function EmptyHint({ text }) {
  return <p className="rounded-lg border border-dashed border-[#2C3037] py-5 text-center text-sm text-[#5B5F68]">{text}</p>;
}
